...
<!-- javascript 파일 링크 -->
<script type="text/javascript" src="resources/js/restaurant/restRegister.js" ></script>
<script type="text/javascript" src="resources/js/restaurant/restInfo.js" ></script>
<script type="text/javascript" src="resources/js/restaurant/menuRegister.js" ></script>
<!-- timepicker 플러그인 링크 -->
<script type="text/javascript" src="resources/js/restaurant/jquery.timepicker.min.js" ></script><!-- 타이머js -->
<link type="text/css" rel="stylesheet" href="resources/css/restaurant/jquery.timepicker.css" media=""/><!-- 타이머css -->
<!-- 카카오 주소 라이브러리 -->
